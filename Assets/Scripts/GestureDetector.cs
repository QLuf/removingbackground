...
public class GestureDetector : IDisposable
{
    ...
    private readonly string leanDB = "GestureDB\\Test.gbd";


    /// <summary> Name of the discrete gesture in the database that we want to track </summary>
    private readonly string leanLeftGestureName = "Hand_Left";
    private readonly string leanRightGestureName = "Hand_Right";
